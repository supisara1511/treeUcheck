    ...
    <center>
      ...
      <form action="{{ route('regMember') }}" method="post">
        ...
        <div style="margin-top:0px; display:inline-block; padding-right:70px; " align="right">
         ...
         <div class="fonts1" style="font-size:15px; margin-top:20px;">
           password<input required type="text" id="fname" name="pass" placeholder="" style="width:500px; margin-left:20px; height:30px;">
         </div>

         <div class="fonts1" style="font-size:15px; margin-top:20px;">
          confirm password<input required type="text" id="fname" name="conpass" placeholder="" style="width:500px; margin-left:20px; height:30px;">
        </div>
